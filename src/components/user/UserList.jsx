              ...
              <td className="border-y-2 px-4 py-2 border-indigo-600">
                <div className="inline-flex rounded-md shadow-sm bg-violet-400" role="group">
                  <Link to={`/user/${user._id}`}
                    className="px-4 py-2 text-sm font-medium bg-stone-400 text-gray-900 bg-transparent border
                  ...
                  <button type="button"
                    ...
                    className="px-4 py-2 text-sm font-medium bg-stone-400 text-gray-900 bg-transparent border-t 
                      border-b border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 
