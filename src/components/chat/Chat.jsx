...
export default function Chat() {
  ...
  return (
    <div className="max-w-4xl w-full h-screen mx-auto px-5 py-5 rounded-t-sm">
      ...
      <hr />
      <form onSubmit={handleSubmit} className="flex bg-gray-300 text-blue-400 p-4 justify-between">
        <input type="text"
          name="message"
          className="w-10/12 bg-gray-100 rounded-lg py-2 px-4"
          placeholder="Escribir un mensaje...  " />
        <button class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 
            focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center 
            inline-flex items-center me-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
